...
<head>
    ...
    <title>Shipment Import - CRM Reconciliation</title>
    <!-- Modern Premium Font -->
    ...
    <style>
        ...
        * {
        ...
        .row-candidates { color: var(--accent-purple); font-weight: 600; }
        ...
        <section>
            <div class="card">
                        ...
                        @if (session('latest_batch'))
                            <div class="stats-grid">
                                ...
                                <div class="stat-card">
                                    ...
                                    <div class="stat-label">New SJ Lines</div>
                                </div>
                                <div class="stat-card">
                                ...
                                <div class="stat-card">
                                    ...
                                    <div class="stat-label">POs Match</div>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="info-panel">
                    💡 <strong>Carry-Forward Parser Rules:</strong><br>
                    - A single Product row dynamically applies to all detail rows below it.<br>
                    - The engine counts possible live allocation candidates (POs Match) in real-time.<br>
                    - *Quantities and PO outstandings are NOT modified during this ingestion step.
                </div>
                ...
                <div class="menu-links">
                    <a href="{{ route('import.po.index') }}" class="menu-link">
                        &rarr; Ke Import Outstanding PO
                    </a>
                    <a href="{{ route('import.stock.index') }}" class="menu-link">
                        &rarr; Ke Import Stock Snapshot
                    </a>
                </div>
            </div>
        </section>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">New Lines</th>
